...
class SoftiZPEnergy(Device):
    ...
    **Properties:**
    ...
    def read_Position(self):
        # PROTECTED REGION ID(ZPEnergy.Position_read) ENABLED START #
        """Return the Position attribute."""
        return self.__position
        # PROTECTED REGION END #    //  ZPEnergy.Position_read

    def write_Position(self, value):
        # PROTECTED REGION ID(ZPEnergy.Position_write) ENABLED START #
        ...
        # PROTECTED REGION END #    //  ZPEnergy.Position_write
    ...
    def read_FocalDist(self):
        # PROTECTED REGION ID(ZPEnergy.FocalDist_read) ENABLED START #
        """Return the FocalDist attribute."""
        return self.__focal_dist
        # PROTECTED REGION END #    //  ZPEnergy.FocalDist_read

    def write_FocalDist(self, value):
        # PROTECTED REGION ID(ZPEnergy.FocalDist_write) ENABLED START #
        ...
        # PROTECTED REGION END #    //  ZPEnergy.FocalDist_write
    ...
    def read_SampleX(self):
        # PROTECTED REGION ID(ZPEnergy.SampleX_read) ENABLED START #
        """Return the SampleX attribute."""
        return self.__sample_x
        # PROTECTED REGION END #    //  ZPEnergy.SampleX_read

    def read_SampleY(self):
        # PROTECTED REGION ID(ZPEnergy.SampleY_read) ENABLED START #
        """Return the SampleY attribute."""
        return self.__sample_y
        # PROTECTED REGION END #    //  ZPEnergy.SampleY_read
